...
public class consultarListaDR extends javax.swing.JInternalFrame {
    ...
    public consultarListaDR(UyTubeFrame padre, String lista, Integer id_user) {
        initComponents();
        setVisible(true);
    ...
    private void BotonConsultarVideoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonConsultarVideoActionPerformed
        ...
        p.AgregarInternalFrame(new consultarVideo(vdt));
        this.dispose();
    ...
    private void setInformacionLista() {
        ...
        jLabel5.setText("Categoria: " + dt.getCategoria());
        obtenerVideosLista();
    }
