...
INSERT INTO `USUARIO` VALUES (1,'Rubino','1962-02-25','hrubino.jpg','horacio.rubino@guambia.com.uy','hrubino','Horacio','Rufus123'),(2,'Buscaglia','1972-06-14','mbusca.jpg','Martin.bus@agadu.org.uy','mbusca','Martín','Cookie234'),(3,'Guido','1954-01-07',NULL,'hector.gui@elgalpon.org.uy','hectorg','Héctor','Poncho345'),(4,'Cardozo','1971-07-24','tabarec.jpg','tabare.car@agadu.org.uy','tabarec','Tabaré','Ketchup1'),(5,'Silva','1947-01-01','cachilas.jpg','Cachila.sil@c1080.org.uy','cachilas','Waldemar \'Cachila\'','Sancho456'),(6,'Bocca','1967-03-16',NULL,'juliobocca@sodre.com.uy','juliob','Julio','Salome56'),(7,'Parodi','1975-01-01',NULL,'diego@efectocine.com','diegop','Diego','Ruffo678'),(8,'Herrera','1840-04-25','kairoh.jpg','kairoher@pilsenrock.com.uy','kairoh','Kairo','Corbata15'),(9,'Henderson','1940-08-03',NULL,'Robin.h@tinglesa.com.uy','robinh','Robin','Aquiles67'),(10,'Tinelli','1960-04-01',NULL,'marcelot@ideasdelsur.com.ar','marcelot','Marcelo','Mancha890'),(11,'Novick','1952-07-17',NULL,'edgardo@novick.com.uy','novick','Edgardo','Xenon987'),(12,'Puglia','1950-01-28',NULL,'puglia@alpanpan.com.uy','sergiop','Sergio','Sultan876'),(13,'Recoba','1976-03-17','chino.jpg','chino@trico.org.uy','chino','Alvaro','Laika765'),(14,'Pacheco','1955-02-14','tonyp.jpg','eltony@manya.org.uy','tonyp','Antonio','Kitty543'),(15,'Jodal','1960-08-09',NULL,'jodal@artech.com.uy','nicoJ','Nicolás','Albino80');
...
INSERT INTO `VIDEO` VALUES (1,4,'Música','Una cancion de fubol',3.04,'2019-10-23','Locura celeste',_binary '','https://youtu.be/PAfbzKcePx0'),(2,4,'Música','la emocion explota',4.18,'2019-10-23','Niño payaso',_binary '','https://youtu.be/K-uEIUnyZPg'),(3,6,'Música','cancion de los rolin',5.02,'2019-10-23','Sweet child\'o mine',_binary '\0','https://youtu.be/1w7OgIMMRc4'),(4,8,'Música','temaso para la noche de la nostalgia',5.58,'2019-10-23','Dancing in the Dark',_binary '\0','https://youtu.be/129kuDCQtHs'),(5,6,'Música','este medio raro con los nenes',13.42,'2019-10-23','Thriller',_binary '\0','https://youtu.be/sOnqjkJTMaA'),(6,3,'Noticias','mucha emocion',6.26,'2019-10-23','100 años de FING',_binary '\0','https://youtu.be/peGS4TBxSaI'),(7,3,'Noticias','la mitad que la fing jeje',27.22,'2019-10-23','50 años del InCo',_binary '\0','https://youtu.be/GzOJSk4urlM'),(8,3,'Noticias','muy buenos trabajos',1,'2019-10-23','Ingeniería de Muestra 2017',_binary '\0','https://youtu.be/RnaYRA1k5j4'),(9,5,'Carnaval','esta estuvo dificil',57.15,'2019-10-23','Etapa A contramano Liguilla',_binary '','https://youtu.be/Es6GRMHXeCQ'),(10,5,'Carnaval','esta estuvo facil',51.38,'2019-10-23','Etapa Don Timoteo Liguilla',_binary '','https://youtu.be/I_spHBU9ZsI'),(11,6,'Deporte','tremendos goles variados',4.23,'2019-10-23','Show de goles',_binary '\0','https://youtu.be/g46w4_kD_lA'),(12,4,'Deporte','tremendos goles de pacheco',5.48,'2019-10-23','Pacheco goles más recordados',_binary '','https://youtu.be/wlEd6-HsIxI'),(13,6,'Deporte','Presentacion de el nuevo estadio peñarol',207.26,'2019-10-23','Inauguración Estadio Peñarol',_binary '\0','https://youtu.be/U6XPJ8Vz72A'),(14,5,'Deporte','tremendos goles de recoba',13.36,'2019-10-23','Recoba 20 mejores goles',_binary '','https://youtu.be/Gy3fZhWdLEQ'),(15,15,'Ciencia y Tecnología','entrevista realizada el 13/7/1527',5.39,'2019-10-23','Entrevista a director CUTI',_binary '','https://youtu.be/Eq5uBEzI6qs'),(16,15,'Ciencia y Tecnología','Muy complicado este tema, hicimos un video para aclarar',19.21,'2019-10-23','Ventana al futuro Uruguay y déficit de ingenieros',_binary '','https://youtu.be/zBR2pnASlQE');
...
-- Dump completed on 2019-10-23 19:54:23
